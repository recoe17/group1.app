...
public class SchoolManagementSystem {
    ...
    private void searchStudentMenu() {
        ...
        switch (option) {
            ...
            case 2 -> {
                ...
                List<Student> found = searchStudentByName(name);
                printStudentList(found);
            }
            case 3 -> {
                String className = readRequired("Class: ");
                List<Student> found = searchStudentByClass(className);
                printStudentList(found);
            }
    ...
    private void showReportsMenu() {
        System.out.println("Reports: 1) All students 2) Fee balances 3) Attendance summary 4) Academic summary");
